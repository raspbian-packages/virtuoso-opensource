...
grant execute on DB.DBA."BaseStruct" to public;
...
grant execute on DB.DBA."ExtendedStruct" to public;

create type DB.DBA."MoreExtendedStruct" under DB.DBA."ExtendedStruct" as ("booleanMessage" smallint __soap_type 'boolean');
grant execute on DB.DBA."MoreExtendedStruct" to public;

-- virtual directory setup
create user "interop4hcr";
